        ...
        if (
            ...
            $Pools | Where-Object Algorithm -eq $MinerAlgo | ForEach-Object {
                ...
                [PSCustomObject]@{
                    ...
                    DeviceCall        = "trex"
                    Arguments         = "-a $($MinerConfig.$ConfigType.naming.$($_.Algorithm)) --no-watchdog --no-nvml -o $stratum$($_.Pool_Host):$($_.Port)  --api-bind-http 0.0.0.0:$Port2 -u $($GetUser) $UserPass-l `'$Log`' --api-bind-http 0.0.0.0:$Port $($MinerConfig.$ConfigType.commands.$($_.Algorithm))"
